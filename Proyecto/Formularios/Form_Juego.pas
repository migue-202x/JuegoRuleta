    ...
    //Si el numero de jugada de la pantalla es distito a la ultima jugada significa que el jugador no esta jugando la partida actual
      ...
      begin
        ...
        begin
          ...
          MessageDlg('SE ESTA JUGANDO PARTIDA NRO. ' +RegJuegoRuleta.NroJugada+ ':'+#13+#13+'Deberá esperar hasta que una nueva partida comience!',mtInformation , [mbOK], 0)
      end
      else
        refrezcarPantallaNormalUser();
    end;
...
//Esta casilla sera estará disponible si se lleva a cabo una apuesta y no cuando hace trampa
var
  Nro_Jugada: Type_JUEGO.tClave;
begin
  Nro_Jugada:= Lbl_nroPartida.Caption;
...
//El tablero volvera a su tamaño original luego de que se haya efecuado un 'click'
